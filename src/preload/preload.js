...
win11QuickFix: (payload) => ipcRenderer.invoke('win11:quickFix', payload),
...
modsList: () => ipcRenderer.invoke('mods:list'),
  ...
  bedrockWin11QuickFix: () => ipcRenderer.invoke('bedrock:win11QuickFix'),
  ...
  bedrockVersionToolOpen: (mode, source) => ipcRenderer.invoke('bedrock:versionToolOpen', { mode, source }),
